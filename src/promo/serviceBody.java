...
public class serviceBody implements InterfacePromo {
    ...
    public void readPromoBarang(JTable data) {
        String kolom[] = {"Kode Promo", "Kode Barang", "Nama Barang", "Jenis", "Promo","Priode"};
    ...
    @Override
    public void createUpdatePromoBarang(String kd_promo, String kd_barang, String nm_barang, String jenis, Double promo, String priode, int tag) {
        if (tag == 0) {
            sql = "INSERT INTO promo VALUES('" + kd_promo + "','" + kd_barang + "','" + nm_barang + "','" + jenis + "','" + promo + "','" + priode + "')";
        } else {
            sql = "UPDATE promo SET nm_barang = '" + nm_barang + "', kd_barang ='" + kd_barang + "', jenis='" + jenis + "' , promo = '" + promo + "', priode = '" + priode + "' WHERE kd_promo = '" + kd_promo + "'";
        }
